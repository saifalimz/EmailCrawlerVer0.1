...
for (i = 2; i <= 25; i++) {
  ...
  for (j = 1; j <= 20; j++) {
    macro += 'EVENT TYPE=CLICK SELECTOR="HTML>BODY>DIV>MAIN>DIV>DIV>DIV>DIV:nth-of-type(3)>DIV>DIV:nth-of-type(2)>DIV>DIV:nth-of-type(2)>DIV>DIV>DIV>SECTION:nth-of-type(2)>SECTION>DIV>UL>LI:nth-of-type(' + j + ')>DIV>DIV>A>DIV>P>SPAN" BUTTON=0 MODIFIERS="meta"' + '\n';
    macro += 'WAIT SECONDS=2' + '\n';
  }
